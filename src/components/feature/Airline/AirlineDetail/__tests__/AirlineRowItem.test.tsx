...
describe('AirlineRowItem Component', () => {
  it('should render the label and value correctly', () => {
    const { getByText } = render(<AirlineRowItem label="Rating" value="5 Stars" />)
  ...
  it('should not render any icon if none is provided', () => {
    const { queryByTestId } = render(<AirlineRowItem label="No Icon" value="None" />)
  ...
  it('should not render a chevron-right icon when onPress is not provided', () => {
    const { queryByTestId } = render(<AirlineRowItem label="Not Clickable" value="Static" />)
  ...
  it('should be disabled when no onPress handler is provided', () => {
    const mockedHandlePress = jest.fn()
    const { getByText } = render(<AirlineRowItem label="Disabled" value="Cannot Click" />)
...
describe('AirlineRowItem Component Snapshot', () => {
  it('should render the AirlineRowItem Component successfully', () => {
    const { toJSON } = render(
      <AirlineRowItem
...
describe('AirlineRowItem Component Snapshot', () => {
  it('should render the AirlineRowItem Component without icon and onPress successfully', () => {
    const { toJSON } = render(<AirlineRowItem label="Rating" value="5 Stars" />)

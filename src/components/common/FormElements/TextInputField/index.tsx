...
const TextInputFieldComponent = <T extends FieldValues>(
  {
    autoCapitalize = 'none',
    autoCorrect = false,
...
export const TextInputField = forwardRef(TextInputFieldComponent) as <T extends FieldValues>(
  props: TextInputFieldProps<T> & { ref?: Ref<TextInput> },
) => ReactElement
